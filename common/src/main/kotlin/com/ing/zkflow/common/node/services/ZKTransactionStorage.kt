...
interface ZKWritableTransactionStorage<T> : ZKTransactionStorage<T> {
    ...
    /**
     * Returns a future that completes with the transaction corresponding to [id] once it has been committed. Do not com.ing.zkflow.generator.warn when run inside
     * a DB transaction.
     */
