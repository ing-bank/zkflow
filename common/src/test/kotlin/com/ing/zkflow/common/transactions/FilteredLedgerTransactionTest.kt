...
import com.ing.zkflow.common.contracts.filterPubliclyVisible
...
class FilteredLedgerTransactionTest {
    ...
    fun filteredLedgerTransactionsAreEqual() {
        withTestSerializationEnvIfNotSet {
            ...
            val manuallyFilteredLtx = unfilteredLtx.filterPubliclyVisible(wtx.zkTransactionMetadata(services))
...
private fun BaseTransaction.confirmExpectedVisibilityAfterFiltering(visible: List<ContractState>, invisible: List<ContractState>) {
