...
class CustomSerializationSchemeDriverTest {
    ...
    fun foo() {
        createTestSerializationEnv(this::class.java.classLoader).asTestContextEnv {
        }
    }
    ...
    open class CustomJsonScheme : CustomSerializationScheme {
        private val mapper = ZincJacksonSupport.createDefaultMapper(fullParties = true)
        ...
        override fun <T : Any> deserialize(
            ...
            return mapper.readValue(bytes.copyBytes(), clazz)
        }

        override fun <T : Any> serialize(obj: T, context: SerializationSchemeContext): ByteSequence {
            return ByteSequence.of(mapper.writeValueAsBytes(obj))
        }
    }
}
