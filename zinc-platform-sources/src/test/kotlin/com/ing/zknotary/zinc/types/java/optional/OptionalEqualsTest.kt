...
@ExperimentalTime
class OptionalEqualsTest {
    private val log = loggerFor<OptionalEqualsTest>()
    private val zincZKService = getZincZKService<OptionalEqualsTest>()
    ...
    fun `zinc equals smoke test`(dataPair: Triple<Int, Int, Boolean>) {
