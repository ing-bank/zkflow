...
object CordaX500NameSerializer : FixedLengthKSerializerWithDefault<CordaX500Name> {
    ...
    private data class CordaX500NameSurrogate(
        ...
        object CommonNameSerializer_1 : FixedSizeUtf8StringSerializer(CordaX500Name.MAX_LENGTH_COMMON_NAME)

        object OrganisationUnitSerializer_0 : NullableSerializer<String>(OrganisationUnitSerializer_1)
        object OrganisationUnitSerializer_1 : FixedSizeUtf8StringSerializer(CordaX500Name.MAX_LENGTH_ORGANISATION_UNIT)

        object OrganisationSerializer_0 : FixedSizeUtf8StringSerializer(CordaX500Name.MAX_LENGTH_ORGANISATION)

        object LocalitySerializer_0 : FixedSizeUtf8StringSerializer(CordaX500Name.MAX_LENGTH_LOCALITY)

        object StateSerializer_0 : NullableSerializer<String>(StateSerializer_1)
        object StateSerializer_1 : FixedSizeUtf8StringSerializer(CordaX500Name.MAX_LENGTH_STATE)

        object CountrySerializer_0 : FixedSizeUtf8StringSerializer(LENGTH_COUNTRY)
