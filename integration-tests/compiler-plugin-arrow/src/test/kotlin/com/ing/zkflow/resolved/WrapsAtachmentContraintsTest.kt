...
class WrapsAttachmentConstraintsTest : SerializerTest {
    @ParameterizedTest
    @MethodSource("engines")
    fun `WrapsBasic make a round trip`(engine: SerdeEngine) {
        engine.assertRoundTrip(
            com.ing.zkflow.annotated.WrapsAttachmentConstraints.serializer(),
            com.ing.zkflow.annotated.WrapsAttachmentConstraints()
        )
    }
    ...
    fun `WrapsBasic generated and manual serializations must coincide`(engine: SerdeEngine) {
        engine.serialize(
            ...
            engine.serialize(WrapsAttachmentConstraints.serializer(), WrapsAttachmentConstraints())
    }
}
