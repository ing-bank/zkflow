...
data class WrapsParties constructor (
    ...
    object AnonymousPartyFullyCustom_0 : com.ing.zkflow.serialization.serializer.SurrogateSerializer<AnonymousParty, AnonymousParty_EdDSA>(
        AnonymousParty_EdDSA.serializer(), { AnonymousParty_EdDSA_Converter.from(it) }
    )
    ...
    object PartyFullyCustom_0 : com.ing.zkflow.serialization.serializer.SurrogateSerializer<Party, Party_EdDSA>(
        Party_EdDSA.serializer(), { Party_EdDSA_Converter.from(it) }
    )
}
