...
data class WrapsPublicKeys(
    ...
    @Serializable(with = PkFullyCustom_0::class) val pkFullyCustom: @Converter<PublicKey, EdDSAPublicKeySurrogate>(
        EdDSAPublicKeyConverter::class
    ...
    object PkFullyCustom_0 : SurrogateSerializer<PublicKey, EdDSAPublicKeySurrogate>(
        EdDSAPublicKeySurrogate.serializer(), { EdDSAPublicKeyConverter.from(it) }
    )
}
