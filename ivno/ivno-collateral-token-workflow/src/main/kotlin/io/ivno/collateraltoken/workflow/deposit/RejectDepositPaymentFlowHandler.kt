...
class RejectDepositPaymentFlowHandler(
    ...
    @InitiatedBy(RejectDepositPaymentFlow.Initiator::class)
    private class Handler(private val session: FlowSession) : FlowLogic<SignedTransaction>() {

        private companion object {
            object HANDLING : ProgressTracker.Step("Handling deposit payment rejection.") {
        ...
        override fun call(): SignedTransaction {
            ...
            return subFlow(RejectDepositPaymentFlowHandler(session, HANDLING.childProgressTracker()))
        }
    }
}
