...
class IssueDepositPaymentFlowHandler(
    ...
    @InitiatedBy(IssueDepositPaymentFlow.Initiator::class)
    private class Handler(private val session: FlowSession) : FlowLogic<SignedTransaction>() {

        private companion object {
            object HANDLING : ProgressTracker.Step("Handling deposit payment issuance.") {
        ...
        override fun call(): SignedTransaction {
            ...
            return subFlow(IssueDepositPaymentFlowHandler(session, HANDLING.childProgressTracker()))
        }
    }
}
