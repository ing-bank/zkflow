...
class CancelTransferFlowHandler(
    ...
    @InitiatedBy(CancelTransferFlow.Initiator::class)
    private class Handler(private val session: FlowSession) : FlowLogic<SignedTransaction>() {

        private companion object {
            object HANDLING : ProgressTracker.Step("Handling transfer cancellation.") {
        ...
        @Suspendable
        override fun call(): SignedTransaction {
            return subFlow(CancelTransferFlowHandler(session, HANDLING.childProgressTracker()))
        }
    }
}
