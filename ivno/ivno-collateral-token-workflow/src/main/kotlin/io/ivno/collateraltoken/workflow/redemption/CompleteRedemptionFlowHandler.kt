...
class CompleteRedemptionFlowHandler(
    ...
    @InitiatedBy(CompleteRedemptionFlow.Initiator::class)
    private class Handler(private val session: FlowSession) : FlowLogic<SignedTransaction>() {

        private companion object {
            object HANDLING : ProgressTracker.Step("Handling redemption completion.") {
        ...
        @Suspendable
        override fun call(): SignedTransaction {
            return subFlow(CompleteRedemptionFlowHandler(session, HANDLING.childProgressTracker()))
        }
    }
}
