...
class RejectDepositFlowHandler(
    ...
    @InitiatedBy(RejectDepositFlow.Initiator::class)
    private class Handler(private val session: FlowSession) : FlowLogic<SignedTransaction>() {

        private companion object {
            object HANDLING : ProgressTracker.Step("Handling deposit rejection.") {
        ...
        override fun call(): SignedTransaction {
            ...
            return subFlow(RejectDepositFlowHandler(session, HANDLING.childProgressTracker()))
        }
    }
}
