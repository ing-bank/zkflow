...
class RequestDepositFlowHandler(
    ...
    @InitiatedBy(RequestDepositFlow.Initiator::class)
    private class Handler(private val session: FlowSession) : FlowLogic<SignedTransaction>() {

        private companion object {
            object HANDLING : ProgressTracker.Step("Handling deposit request.") {
        ...
        override fun call(): SignedTransaction {
            ...
            return subFlow(RequestDepositFlowHandler(session, HANDLING.childProgressTracker()))
        }
    }
}
