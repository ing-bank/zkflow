...
class RequestRedemptionFlowHandler(
    ...
    @InitiatedBy(RequestRedemptionFlow.Initiator::class)
    private class Handler(private val session: FlowSession) : FlowLogic<SignedTransaction>() {

        private companion object {
            object HANDLING : ProgressTracker.Step("Handling redemption request.") {
        ...
        @Suspendable
        override fun call(): SignedTransaction {
            return subFlow(RequestRedemptionFlowHandler(session, HANDLING.childProgressTracker()))
        }
    }
}
