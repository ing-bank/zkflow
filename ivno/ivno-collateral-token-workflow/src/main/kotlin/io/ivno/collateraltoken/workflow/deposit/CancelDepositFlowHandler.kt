...
class CancelDepositFlowHandler(
    ...
    @InitiatedBy(CancelDepositFlow.Initiator::class)
    private class Handler(private val session: FlowSession) : FlowLogic<SignedTransaction>() {

        private companion object {
            object HANDLING : ProgressTracker.Step("Handling deposit cancellation.") {
        ...
        override fun call(): SignedTransaction {
            ...
            return subFlow(CancelDepositFlowHandler(session, HANDLING.childProgressTracker()))
        }
    }
}
