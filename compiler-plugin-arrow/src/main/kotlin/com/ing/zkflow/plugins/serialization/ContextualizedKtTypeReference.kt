...
class ContextualizedKtTypeReference(
     ...
     * placed in the package of the surrogate and
    ...
    fun findSurrogateSerializer(): FqName? {
        ...
        return ktTypeReference.findAnnotation<Via<*>>()?.let {
            ...
            val surrogatePackageSegments = surrogateFqName.pathSegments().take(surrogateFqName.pathSegments().size - 1)
            val surrogateSerializerFqName = FqName.fromSegments(
                surrogatePackageSegments.map(Name::asString) +
