...
class ZincTypeGeneratorTest {
    ...
    companion object {
        ...
        fun fixturesProvider(): List<Arguments> = listOf(
            ...
            Arguments.of(ClassWithUtf16String.serializer().descriptor, structWithUtf16String),
            Arguments.of(ClassWithUtf32String.serializer().descriptor, structWithUtf32String),
