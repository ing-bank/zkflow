...
class ZincTypeGeneratorTest {
    ...
    companion object {
        ...
        fun fixturesProvider(): List<Arguments> = listOf(
            ...
            Arguments.of(ClassWithUByteSerializer.descriptor, structWithUByte),
            Arguments.of(ClassWithShortSerializer.descriptor, structWithShort),
            Arguments.of(ClassWithUShortSerializer.descriptor, structWithUShort),
            Arguments.of(ClassWithIntSerializer.descriptor, structWithInt),
            Arguments.of(ClassWithUIntSerializer.descriptor, structWithUInt),
            Arguments.of(ClassWithLongSerializer.descriptor, structWithLong),
            Arguments.of(ClassWithULongSerializer.descriptor, structWithULong),
