    ...
    TemplateParameters(
        ...
        listOf(
            ...
            AttachmentConstraintTemplateParameters.selectParameters(
                metadata.network.attachmentConstraintType.kClass.qualifiedConstraintClassName
            ).polymorphic(),
    ...
    override fun getReplacements() =
        getTypeReplacements("USER_STATE_") +
            ...
            AttachmentConstraintTemplateParameters
                .selectParameters(metadata.network.attachmentConstraintType.kClass.qualifiedConstraintClassName)
                .polymorphic()
