...
class Merkle(private val circuitName: String, private val mergedCircuitOutput: File, private val circuitSourcesBase: File) {
     ...
     **/
    fun setCorrespondingMerkleTreeFunctionForComponentGroups() {
