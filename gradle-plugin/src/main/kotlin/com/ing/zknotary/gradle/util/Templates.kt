...
fun generateFloatingPointsCode(targetFilePath: String, templateContents: String, bigDecimalSizes: Set<Pair<Int, Int>>) {
    bigDecimalSizes.forEach {
        ...
        val targetFile = File("$targetFilePath/floating_point_$sizeSuffix.zn")
...
fun generateMerkleUtilsCode(targetFilePath: String, templateContents: String, constsContent: String) {
    val targetFile = File("$targetFilePath/merkle_utils.zn")
    targetFile.parentFile?.mkdirs()
    targetFile.delete()
    targetFile.createNewFile()
...
fun generateMainCode(targetFilePath: String, templateContents: String, constsContent: String, circuitName: String) {

    val targetFile = File("$targetFilePath/main.zn")
    targetFile.parentFile?.mkdirs()
    targetFile.delete()
    targetFile.createNewFile()
    targetFile.writeText("//! GENERATED CODE. DO NOT EDIT\n//! Edit it in zk-notary GenerateZincPlatformCodeFromTemplatesTask.kt\n")
